...
class Start_Work(QWidget):
    def __init__(self,foo,table):
        super().__init__()
       
        self.foo = foo
        self.tab = table
        self.setWindowTitle("Устройство на работу")
        ...
        self.price.move(75, 250)
        self.price.resize(125,25)
        self.price.setPlaceholderText("Оклад")
        self.work_info.addWidget(self.price)
        ...
        self.btn_save.setText("Устроить\n на работу")
    ...
    def catch_data(self):
        ...
        if len(self.g) == 0:
            ...
            return 0
        self.h = self.price.text()
        if len(self.h) == 0:
            QMessageBox.warning(self, 'Warning', 'Введите оклад')
            return 0
        ...
        try:
            ...
            Database.save(self,today.strftime("%d.%m.%Y"),self.a,self.b,self.c,self.d,self.e,self.f,self.g,self.h,self.i)
